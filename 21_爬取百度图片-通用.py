# -*- coding:utf8 -*-
# 代码博客网址：https://blog.csdn.net/libaiup/article/details/134028174
...
class BaiduImageSpider(object):
    def __init__(self):
        ...
        self.directory = r"C:\Users\Kyrie Irving\Desktop\python_test\downloaded_images"  # 存储目录  这里需要修改为自己希望保存的目录  {}不要丢
        self.header = {
